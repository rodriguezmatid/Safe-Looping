...
# X = df_cleaned[['avg_stableBorrowRate_eth_rates', 'avg_supplyRate_eth_rates', 'weekly_change_usdc', 'moving_average_7_price_eth', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_7', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_21', 'moving_average_21_price_usdc', 'price_eth', 'moving_average_14_price_eth', 'market_cap_eth_volume', 'moving_average_7_volume_eth', 'moving_average_7_mc_eth', 'moving_average_14_mc_eth', 'moving_average_21_mc_eth', 'moving_average_30_mc_eth', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_14', 'borrows_volume_v3_eth_daily_deposits_borrows_ma_7', 'borrows_volume_v3_eth_daily_deposits_borrows_ma_14', 'borrows_volume_v3_eth_daily_deposits_borrows_ma_21', 'borrows_volume_v3_eth_daily_deposits_borrows_ma_30', 'borrows_volume_v3_usdc_daily_deposits_borrows_ma_7', 'avg_liquidityIndex_eth_rates', 'avg_variableBorrowIndex_eth_rates', 'volumes_last_24h_eth_volume', 'avg_liquidityIndex_usdc_rates', 'avg_variableBorrowIndex_usdc_rates', 'moving_average_21_price_eth', 'avg_stableBorrowRate_eth_rates_ma_7', 'avg_stableBorrowRate_eth_rates_ma_14', 'avg_supplyRate_eth_rates_ma_7', 'avg_supplyRate_eth_rates_ma_14', 'avg_liquidityIndex_eth_rates_ma_7']] # 10
# X = df_cleaned[['avg_stableBorrowRate_eth_rates', 'avg_supplyRate_eth_rates', 'weekly_change_usdc', 'moving_average_7_price_eth', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_7', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_21', 'moving_average_21_price_usdc']] # 11
# X = df_cleaned[['market_cap_eth_volume', 'avg_stableBorrowRate_eth_rates', 'avg_supplyRate_eth_rates', 'avg_stableBorrowRate_eth_rates_ma_7', 'avg_stableBorrowRate_eth_rates_ma_14', 'avg_supplyRate_eth_rates_ma_7', 'avg_supplyRate_eth_rates_ma_14', 'avg_liquidityIndex_eth_rates_ma_7']] # 12
# X = df_cleaned[['avg_stableBorrowRate_eth_rates', 'avg_supplyRate_eth_rates', 'weekly_change_usdc', 'avg_stableBorrowRate_eth_rates_ma_7', 'avg_stableBorrowRate_eth_rates_ma_14', 'avg_supplyRate_eth_rates_ma_7']] # 13
# X = df_cleaned[['avg_stableBorrowRate_eth_rates', 'avg_supplyRate_eth_rates', 'weekly_change_usdc', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_7', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_21', 'price_eth', 'moving_average_14_price_eth', 'deposits_volume_v3_eth_daily_deposits_borrows_ma_14', 'borrows_volume_v3_eth_daily_deposits_borrows_ma_21', 'moving_average_21_price_eth', 'avg_stableBorrowRate_eth_rates_ma_7', 'avg_stableBorrowRate_eth_rates_ma_14', 'avg_supplyRate_eth_rates_ma_7']] # 14
...
# Guardar los resultados en un CSV
results_df.to_csv('datasets/model_15.csv', index=False)
